  ...
  return (
    <Layout>
      <Routes>
        ...
        <Route path="/nurses" element={<WorkforcePlanning />} />
        ...
        {/* Backward-compatible alias for the original nurse planning route */}
        <Route path="/planning" element={<Navigate to="/nurses" replace />} />
